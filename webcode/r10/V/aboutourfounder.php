...
class TheView extends V_Layouts_LeftNav1 {
	public $pageTitle = 'Our Founder';
	public $pageLayout = '01112';
	public $pageMenu = 'au.of';
	
	function doArea1() {
?>
	<h1 class="atTop">Our Founder:  Hans J. Moehring</h1>
	<?= G::$accent_p ?> 
	<p>Our founder, Hans J. Moehring, was a visionary who saw the need to
		...
		and insure the sustainability of the investment for each owner.</p>
	<p>In 1977, he formed H.J. Moehring Associates and actively began to lobby
		...
		and investing acumen.</p>
	<p>By 1994, there were many different firms heralding themselves as
		...
		lobby for industry standards for Reserve Fund Studies.</p>
	<p>In 1998, The Ontario &#8220;Condominium Act&#8221; was created to replace
		the old statutes and introduced sweeping changes including reserve fund
		studies as an integral requirement for Condominium Corporations.</p>
	<p>From 1999 to 2001, Hans J. Moehring worked closely as a prime consultant
		with the Ministry of Consumer and Commercial Relations to develop the
		regulations specific to Reserve Fund Studies.</p>
	<p>In 1999, Hans J. Moehring also delivered a proposal to the Real Estate
		...
		perform Reserve Fund Studies.</p>
	<p>This course curriculum is still being taught today through the Real
